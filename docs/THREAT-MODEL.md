...
| Malicious served client code | **Top residual, not solved by optics** | Web trust base (residual R1). Mitigated by strict CSP, non-extractable keys, out-of-band published build hashes, and later an extension. |
